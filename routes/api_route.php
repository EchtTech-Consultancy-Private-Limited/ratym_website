...
//Route::prefix('api')->group(function(){
    Route::middleware(['auth','prevent-back-history','logs','EnsureTokenIsValid'])->group(function () {
        ...
        Route::group(['prefix' => 'api/v1'], function () {
            ...
            Route::get('/list-ten',[TenderManagementAPIController::class,'index'])->name('tender-list-api');
            ...
            Route::get('/list-nw',[NewsManagementAPIController::class,'index'])->name('news-list-api');

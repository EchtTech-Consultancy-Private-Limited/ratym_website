        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_news" role="grid" aria-describedby="kt_datatable_info" style="width: 924px;">
            <thead>
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="kt_datatable_news" rowspan="1" colspan="1">{{__('Start Date')}}</th>
                    <th class="sorting" tabindex="0" aria-controls="kt_datatable_news" rowspan="1" colspan="1">{{__('End Date')}}</th>
